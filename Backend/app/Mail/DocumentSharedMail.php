...
class DocumentSharedMail extends Mailable
{
    ...
    public function __construct(Document $document, Tenant $tenant, ?User $user = null, ?string $externalEmail = null, string $frontendUrl = 'https://gestiloc-front.vercel.app')
    {
