  ...
  return (
    <div>
      ...
      >
        ...
        <span className="text-[0.9rem] font-bold whitespace-nowrap transition-colors duration-300 text-gray-500" style={{ 
          color: ((isActive || isChildActive || hovered) && !item.isLogout) ? TEXT_GREEN : undefined,
...
export const Layout: React.FC<LayoutProps> = ({
  ...
  return (
    <div className="min-h-screen h-screen w-screen overflow-hidden flex flex-col" style={{ background: "#fff", fontFamily: "'Merriweather', serif" }}>
      {/* HEADER */}
